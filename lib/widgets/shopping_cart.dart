...
class _ShoppingCartState extends State<ShoppingCart> {
  ...
  Widget build(BuildContext context) {
    ...
    double subtotal = items.fold(0.0, (total, item) => total + item.price * item.quantity);
    double discount = items.fold(0.0, (d, item) => d + item.price * item.discount * item.quantity);
      ...
      children: [
        Wrap(
          ...
          children: [
            ElevatedButton(
              onPressed: () =>
                  cartService.addItem('1', 'Apple iPhone', 999.99, discount: 0.1),
              child: const Text('Add iPhone'),
            ),
            ElevatedButton(
              onPressed: () =>
                  cartService.addItem('2', 'Samsung Galaxy', 899.99, discount: 0.15),
